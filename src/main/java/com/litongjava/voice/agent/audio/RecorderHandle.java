...
public class RecorderHandle {
  ...
  public RecorderHandle(String sessionId, int userSampleRate, int modelSampleRate) throws IOException {
    ...
    this.userRaw = Path.of(SessionAudioConst.TEMP_RECORDINGS_OUT_DIR, "session-" + sessionId + "_user.pcm");
    this.modelRaw = Path.of(SessionAudioConst.TEMP_RECORDINGS_OUT_DIR, "session-" + sessionId + "_model.pcm");
    this.userWav = Path.of(SessionAudioConst.TEMP_RECORDINGS_OUT_DIR, "session-" + sessionId + "_user.wav");
    this.modelWav = Path.of(SessionAudioConst.TEMP_RECORDINGS_OUT_DIR, "session-" + sessionId + "_model.wav");

    // ensure directory exists
    Files.createDirectories(Path.of(SessionAudioConst.TEMP_RECORDINGS_OUT_DIR));
  ...
  public Path finishAndClose(AudioFinishCallback callback) {
    ...
    Path outCombined = Path.of(SessionAudioConst.RECORDINGS_OUT_DIR,
